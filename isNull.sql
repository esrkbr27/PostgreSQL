...
update insanlar
set isim ='NO NAME'  -->yeni ismi yaz
WHERE isim is null;  -->null tırnak içinde değil DİKKAT!

-- Tabloyu eski haline geri getirin
...
--NOT:
--Çoklu değişimde her değişim için SET... WHERE ism is null ifade 
--yazmamak için COALES (BİRLEŞTİRME) kullanılır.
