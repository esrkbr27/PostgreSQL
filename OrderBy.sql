...
--Order Bye cümleciği bir sorgu deyımı içersinde belli bir sütuna göre
...
select * from kisiler ORDER BY adres asc;--> Ascending (asc) yazmasak da sıralı verir

--kişiler tablosunu adrese göre tersten sıralayın

select * from kisiler ORDER BY adres desc; -->Descending (desc) tersten sıralama yapar

--kisiler tablosunda maası buyukten kucuge dogru sıralayınız

select * from kisiler order by maas asc; -->kucukten buyuge 
